# Instruções de Desenvolvimento - appColeta
...
- **Exemplo**: `src/winAppColeta.mlapp`, `src/+auxApp/winAddTask.mlapp`
...
- **Exemplo**: `src/winAppColeta_exported.m` (gerado de `src/winAppColeta.mlapp`)
